...
合约部署在 FISCO BCOS 链上，地址为 `0x6849f21d1e455e9f0712b1e99fa4fcd23758e8f1`，提供以下功能：
...
│   ├── requirements.txt               # Python 依赖：fastapi, uvicorn, sqlalchemy, pymysql, python-jose, passlib, httpx
